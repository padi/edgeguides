...
* To run Solidus in conjunction with an external CDN you will have to do some configuration steps outlined below.
...
Solidus depends on any different components and gems. Always keep an eye out to temporary changes due to updates to dependencies. If you feel something is not right checkout the readme file in the Solidus repository. 
